...
It must has the columns name "SampleID" and "BarcodeSequence", and two more colums to identified the files separate by barcode. Also you can leave that colums in blank.
